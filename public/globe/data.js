function ajaxLoad(e) {
	if (!e.hasClass("loading")) {
		var t = e.data("page") ? parseInt(e.data("page")) : 1,
			n = e.data("pages") ? parseInt(e.data("pages")) : 1,
			i = e.data("action"),
			o = e.data("method") ? e.data("method") : "GET";
	...
	function n(e, t) {
		switch (typeof e) {
			...
			default:
				var i, o = [];
				for (i in e)
					if (o.push(i), !n(e[i], t[i])) return !1;
				for (i in t)
					if (o.indexOf(i) < 0) return !1;
				return !0
		}
	}
...
! function(e, t) {
	t(e).ready(function() {
		...
		function i(e) {
			var t = Math.ceil(u.width() / 2),
				n = Math.ceil(u.height() / 2),
				i = e.pageX - t,
				o = e.pageY - n;
...
function(e, t) {
	...
	function a(e, t) {
		console.debug(typeof e), (e || t) && r("change", {
			beta: e,
			gamma: t
		})
	}
...
! function(e) {
	e.trimText = function(e, t, n) {
		...
		var i = [],
			o = e.split(/\r?\n/g);
		if (t = Math.max(t, e.length / n), o.length > 1)
			for (var a = 0; a < o.length; a++) o.splice(a, 1, trimText(o[a], t));
		else
...
! function(e, t) {
	function n() {
		...
		t || (c = setInterval(o, g), o()), i(t), e.cookie("muted", t ? 1 : 0, {
			path: "/",
			expires: 3650
		});
		var n = e(".sound").get(0);
...
function(e, t, n, i, o) {
	function a(e, t, n) {
		...
		function a(e, t, n, i, a) {
			...
			e.css("transform", i || "scale(0)"), o.to(e.get(0), n || .5, {
				transform: a || "scale(1)",
				delay: t
			})
		}
	...
	function r(e, t, n) {
		function a() {
			i(".toogle-map-mobile").stop().fadeOut(300), o.to(e.get(0), .5, {
	...
	i.fn.earthPopupItem = function(e, t) {
		...
		var a, r, h;
		return s || (c = i("#earth-popup[type='text/x-handlebars-template']"), 
		s = t.compile(c.html())), 
		a = i(s(e)).appendTo(c.parent()), 
		a.localization("en"), o && (scriptMobile = i("#earth-mobile-tip[type='text/x-handlebars-template']"), 
		templateMobile = t.compile(scriptMobile.html()), 
		collectionMobile = i(templateMobile(e)).appendTo(scriptMobile.parent()), 
		h = collectionMobile.on(u, function(t, i) {
			n(e[i])
		}).on(p, function(e) {
			i(e.target).remove()
		}).earthMobileTip(l)), 
	
		r = a.find(".earth-popup__item").on(p, function() {
			a.remove(), a = void 0, r = void 0
		}).earthPopupItem(l, !!o), 
		o || r.on(u, function(t, i) {
			n(e[i])
...
function(e, t, n, i) {
	function a(e) {
		...
		// 	this.desc = o, this.activeYears = !1, i.currentYear || (i.currentYear = a);
		// 	for (index in o) {
		// 		var r = o[index] == a ? "js-timeline-item timeline-new__item active" : "js-timeline-item timeline-new__item";
		// 		e.append('<div data-year="' + o[index] + '" class="' + r + '">' + o[index] + "</div>")
		// 	}
		...
		// },
		 this.initLinks = function(e, n) {
			...
			}, {}), this.desc.forEach(t.proxy(function(e) {
...
! function(e, t, n, i, o) {
	...
	function r(i) {
		function o() {
			...
			if (!e.liked) {
				...
				t(".user__button .user__button-counter").text(parseInt(i) + 1), t(".user__button").addClass("active"), t(".user__button .user__button-icon").html(c), e.likeApi({
	...
	function s(e) {
			...
			if (i) {
				if ("string" == typeof i) {
					...
					for (var o = 0; o < i.length; o++) {
						var a = i[o],
							r = a.data.split(";");
						a.x = parseFloat(r[0]), a.y = parseFloat(r[1]), a.z = parseFloat(r[2]), 
						a.name = a.brief_name, 
						a.link = a.brief_id
					}
				}
		...
		var u = t(".js-vr-tutor, .js-close-vr-tutor"),
			p = t("body");
...
! function(e, t, n, o, a, r, s, c) {
	...
	function d(e, t, n) {
		...
		}), e.on("mouseenter  mouseleave", i), this.mapPoint = e.find(".hexagonal-map__point").css({
			transform: "scale(0)"
		})
	}
	...
	v.show = function(e) {
		...
		function k(e, i) {
			...
			var s = e,
				...
				p = x(c, s.info);
			i.remove();
			var h = C(p.points, p.centerPointIndex, S[E].briefs.length),
				m = f(p.points);
		...
		function x(e, n) {
			for (var i, o = e.data, a = e.width, r = e.height, s = -n.dx, c = -n.dy, d = Math.ceil(1.5 * n.width + l.offset), u = Math.ceil(n.height / 2 + l.offset), p = [], f = new t.Point(.5 * a, .5 * r), m = 999999, v = 0, w = c; w < r; w += u, v++)
				for (var b = 0, y = s + (1 & v) * d * .5; y < a; y += d, b++)
					if (h(o, y, w, a)[3] >= g) {
		...
		var S, E, T, z = void 0,
			I = e.closest(".kaspersky-app").find(".city-name"),
			D = Handlebars.compile(e.find('[type="text/x-handlebars-template"]').html()),
			O = new r.Stage(n),
			P = new r.Stage(c),
			L = new p(5),
			q = function(e, t) {
			...
			H = [],
			U = e.find(".hexagonal-map__points-cont"),
			A = {};
...
! function(e, t, n, i) {
	function o(o) {
		...
		var s, c, l = this,
			d = o.find(".modal-message__title"),
			u = o.find(".modal-message__body");
...
function(e, t, n) {
		...
		n.onload = function(e) {
			...
			for (var i = n.byteLength, o = 2; o < i;) {
				...
				if (o += 2, 65505 == a) {
					...
					o += 2;
					for (var c = 0; c < s; c++)
						if (274 == n.getUint16(o + 12 * c, r)) return t(n.getUint16(o + 12 * c + 8, r))
				} else {
	...
	function o(o) {
		...
		var c = 1,
			...
			d = peppers.checkMobile.css.isMobile() ? 484 : 333,
			u = {
				preview: {
					width: d,
					height: d
		...
		o.append(p), t.event && t.event.on(p.get(0), "change", a),
			function() {
...
function(e, t, n) {
	...
	e.fn.userData = t.jQueryConstructor("UserData", i), i.prototype.init = function(e) {
		if ("function" == typeof e) this.api = e;
		else var t = e;
		this.update(t)
...
! function(e, t) {
	...
	function o() {
	 ...
	 document.getElementById("avatar-input") && (document.getElementById("avatar-input").onchange = function() {
		var e = kaspersky.user,
			t = document.getElementById("user-form");
		t.action = e, t.submit()
...
function(e, t, n) {
	function i(n) {
		...
		function l(t) {
			...
			i > g && (i = g), i < v && (i = v), e(this).find(".js-viewer").css({
				width: i,
				height: i
			})
		}
		...
		var m, g = "250",
			v = "100",
			w = {},
			b = n.find(".user-pic-block__image-wrap"),
		...
		var k, _, x = n.find(".select-file").uploadImage().on("upload-image:crop", o),
			C = n.find(".js-viewer");
...
! function(e, t, n) {
	...
	$(n).on("click", ".js-mobile-menu-overlay", function() {
		...
		"#" == n && (n = "");
		var i = "";
		if ("ru" == $(this).data("lang")) i = t.location.origin + "/ru" + t.location.pathname + t.location.search + n;
		else {
			if (-1 != location.href.indexOf("/ru#/")) var a = "/" + t.location.pathname.split("/ru")[1];
			else var a = "/" + t.location.pathname.split("/ru/")[1];
...
function(e, t, n, i) {
	e.fn.welcome = function() {
		...
		var s = [1, 6, 3],
			c = this,
			l = e.Deferred(),
			d = peppers.checkMobile.css.isMobile();
		if (0 === this.length || e.cookie("visited") || d) o();
		else {
			e.cookie("visited", "1", {
				expires: 3650,
				path: "/"
...
function(e, t, n, i, o) {
	function s() {
		o(".hexagonal-map").hexagonalMap(c("location")), t.voteApi = c("agree", void 0, !1, "post"), t.commentApi = c("comment-add", void 0, !1, "post"), t.likeApi = c("work-add_like", void 0, !1, "post"), t.sortPrediction = c("predictions", void 0, !1, "post"), t.sortFuturolog = c("futurolog", void 0, !1, "post"), t.sortArtwork = c("graphics", void 0, !1, "post"), t.sortArtist = c("artists", void 0, !1, "post"), t.searchUrl = langUrl + "search/text/", t.preload = '<div class="svg-preloader"> <div class="g-circles" id="circle"> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> <div class="g-circle"> <div class="u-circle" id="s-circle"> <div class="round"></div> </div> </div> </div></div>', o(".js-select").select2({
			minimumResultsForSearch: 1 / 0
		}), t.sortRedrawList = function(e, n, i, a, r) {
			var s = o(i);
			s.addClass("fade-block"), a({
				sort: e,
				type: n
			}).fail(function(i) {
			...
			if (n) {
				var i = langUrl + "api/" + "locations";
				if (t)
					for (name in t) i = i.replace("{" + name + "}", t[name]);
				return i
			}
			return !1
		}, setTimeout(function() {
			...
			function e(e) {
				...
				o(".timeline-new").pepTimeline(i, e).on("timeline:change", 
				function(e, t) {
					o.cookie(n, t, {
						path: "/",
		...
		function c(e) {
			...
			try {
				for (var n = JSON.parse(t), i = 0; i < n.length; i++)
					if (n[i].name === e) return "1" == n[i].value
			} catch (e) {}
			return !1
		}
	...
	function l() {
		...
		if (e.checkMobile.css.isMobile()) return void o.cookie("visited-2", "1", {
			expires: 3650,
			path: "/"
		});
