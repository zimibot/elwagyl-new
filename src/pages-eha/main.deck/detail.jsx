            ...
            html: (d) => {
                return <Tooltip title={d}>
                    <div className="relative w-full h-5">
                        <div className="flex items-center gap-4 w-full top-0 absolute">
                            <div>
            ...
            <div className="grid grid-cols-7 gap-6 flex-1">
                <div className="col-span-4">
                    <div className="w-full grid grid-cols-3">
                        ...
                        <div className="flex relative h-full space-y-8 flex-col">
                ...
                <div className="col-span-3 space-y-6 flex flex-col">
                    ...
                    <div className="flex flex-col flex-1 gap-4">
                        ...
                        <div className="relative flex flex-col flex-1">
                            <TableInline hoverDisable={true} columns={column} data={data} borderLast={true} border={true}></TableInline>
                        </div>
                    </div>
                </div>
            </div>
