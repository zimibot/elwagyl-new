...
const AvailabilityPages = ({ titlePath }) => {
    ...
    return <LayoutDashboard titlePath={titlePath}>
        ...
        <ColumnCenter>
            <CardAnimation>
                {!maximize.AVAILABLESENSORLIST && <><FillterDay data={value.OPTIONALDATE} keyText={"OPTIONALDATE"}></FillterDay>
                        ...
                        <div className="col-span-2 border-l-primary border-l border-b border-primary border-r-primary border-r flex flex-col">
                            ...
                            <div className="p-4 flex-1 flex flex-col">
                                <div className="grid grid-cols-2 border border-primary flex-1">
                                    <div className="p-4 border-b col-span-2 border-b-primary flex items-center justify-center flex-col" style={{
                                        lineHeight: 1.2,
                                    }}>
                                    ...
                                    <div>
                                        <div className="p-4 flex items-center justify-center flex-col" style={{
                                            lineHeight: 1.2,
                                        }}>
